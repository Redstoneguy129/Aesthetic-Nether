...
public class HangingVineStructure extends Feature<NoFeatureConfig> {

    protected static final ResourceLocation[] TEMPLATE = new ResourceLocation[] {
            new ResourceLocation(AestheticNether.MODID, "hanging_thornvines")
    };

    private TemplateCompiler templateCompiler;

    public HangingVineStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> deserialize) {
        super(deserialize);
    }
    ...
    public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        if(up.equals(Blocks.NETHERRACK) && down.equals(Blocks.AIR) && north.equals(Blocks.AIR) && south.equals(Blocks.AIR) && east.equals(Blocks.AIR) && west.equals(Blocks.AIR)) {
            ...
            CompiledTemplate template = this.templateCompiler.compile(worldIn, rand, pos.down(6));
